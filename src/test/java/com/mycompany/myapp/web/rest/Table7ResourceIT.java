...
import static com.mycompany.myapp.domain.Table7Asserts.*;
...
/**
 * Integration tests for the {@link Table7Resource} REST controller.
 */
@IntegrationTest
@AutoConfigureMockMvc
@WithMockUser
class Table7ResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/table-7-s";
    ...
    @Autowired
    private MockMvc restTable7MockMvc;
     ...
     */
    public static Table7 createEntity(EntityManager em) {
     ...
     * if they test an entity which requires the current entity.
     */
    public static Table7 createUpdatedEntity(EntityManager em) {
        Table7 table7 = new Table7()
    ...
    public void initTest() {
        table7 = createEntity(em);
    }

    @Test
    @Transactional
    void createTable7() throws Exception {
        long databaseSizeBeforeCreate = getRepositoryCount();
        // Create the Table7
        var returnedTable7 = om.readValue(
            restTable7MockMvc
                .perform(post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(table7)))
        ...
        // Validate the Table7 in the database
        assertIncrementedRepositoryCount(databaseSizeBeforeCreate);
        assertTable7UpdatableFieldsEquals(returnedTable7, getPersistedTable7(returnedTable7));
    }

    @Test
    @Transactional
    void createTable7WithExistingId() throws Exception {
        // Create the Table7 with an existing ID
        table7.setId(1L);
    ...
    @Test
    @Transactional
    void getAllTable7s() throws Exception {
        // Initialize the database
        table7Repository.saveAndFlush(table7);

        // Get all the table7List
        restTable7MockMvc
            .perform(get(ENTITY_API_URL + "?sort=id,desc"))
            .andExpect(status().isOk())
            .andExpect(content().contentType(MediaType.APPLICATION_JSON_VALUE))
            .andExpect(jsonPath("$.[*].id").value(hasItem(table7.getId().intValue())))
    ...
    @Test
    @Transactional
    void getTable7() throws Exception {
        // Initialize the database
        table7Repository.saveAndFlush(table7);

        // Get the table7
        restTable7MockMvc
            .perform(get(ENTITY_API_URL_ID, table7.getId()))
            .andExpect(status().isOk())
            .andExpect(content().contentType(MediaType.APPLICATION_JSON_VALUE))
            .andExpect(jsonPath("$.id").value(table7.getId().intValue()))
    ...
    @Test
    @Transactional
    void getNonExistingTable7() throws Exception {
        // Get the table7
        restTable7MockMvc.perform(get(ENTITY_API_URL_ID, Long.MAX_VALUE)).andExpect(status().isNotFound());
    }

    @Test
    @Transactional
    void putExistingTable7() throws Exception {
        // Initialize the database
        table7Repository.saveAndFlush(table7);
        ...
        // Update the table7
        Table7 updatedTable7 = table7Repository.findById(table7.getId()).orElseThrow();
        // Disconnect from session so that the updates on updatedTable7 are not directly saved in db
        em.detach(updatedTable7);
        updatedTable7
            .numLigne1(UPDATED_NUM_LIGNE_1)
            .resort2(UPDATED_RESORT_2)
            .resvNameId3(UPDATED_RESV_NAME_ID_3)
        ...
        restTable7MockMvc
            .perform(
                put(ENTITY_API_URL_ID, updatedTable7.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(om.writeValueAsBytes(updatedTable7))
            )
            .andExpect(status().isOk());

        // Validate the Table7 in the database
        assertSameRepositoryCount(databaseSizeBeforeUpdate);
        assertPersistedTable7ToMatchAllProperties(updatedTable7);
    }

    @Test
    @Transactional
    void putNonExistingTable7() throws Exception {
        long databaseSizeBeforeUpdate = getRepositoryCount();
        table7.setId(longCount.incrementAndGet());

        // If the entity doesn't have an ID, it will throw BadRequestAlertException
        restTable7MockMvc
            .perform(put(ENTITY_API_URL_ID, table7.getId()).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(table7)))
            .andExpect(status().isBadRequest());
    ...
    @Test
    @Transactional
    void putWithIdMismatchTable7() throws Exception {
        long databaseSizeBeforeUpdate = getRepositoryCount();
        table7.setId(longCount.incrementAndGet());
        ...
        restTable7MockMvc
            .perform(
                put(ENTITY_API_URL_ID, longCount.incrementAndGet())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(om.writeValueAsBytes(table7))
            )
            .andExpect(status().isBadRequest());
    ...
    @Test
    @Transactional
    void putWithMissingIdPathParamTable7() throws Exception {
        long databaseSizeBeforeUpdate = getRepositoryCount();
        table7.setId(longCount.incrementAndGet());

        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restTable7MockMvc
            .perform(put(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(table7)))
    ...
    @Test
    @Transactional
    void partialUpdateTable7WithPatch() throws Exception {
        // Initialize the database
        table7Repository.saveAndFlush(table7);

        long databaseSizeBeforeUpdate = getRepositoryCount();

        // Update the table7 using partial update
        Table7 partialUpdatedTable7 = new Table7();
        partialUpdatedTable7.setId(table7.getId());

        partialUpdatedTable7
            .clientOId4(UPDATED_CLIENT_O_ID_4)
            .typeChb5(UPDATED_TYPE_CHB_5)
            .clientMdmId7(UPDATED_CLIENT_MDM_ID_7)
            .nameId8(UPDATED_NAME_ID_8)
        ...
        restTable7MockMvc
            .perform(
                patch(ENTITY_API_URL_ID, partialUpdatedTable7.getId())
                    .contentType("application/merge-patch+json")
                    .content(om.writeValueAsBytes(partialUpdatedTable7))
            )
            .andExpect(status().isOk());
        ...
        assertSameRepositoryCount(databaseSizeBeforeUpdate);
        assertTable7UpdatableFieldsEquals(createUpdateProxyForBean(partialUpdatedTable7, table7), getPersistedTable7(table7));
    }

    @Test
    @Transactional
    void fullUpdateTable7WithPatch() throws Exception {
        // Initialize the database
        table7Repository.saveAndFlush(table7);
        ...
        assertSameRepositoryCount(databaseSizeBeforeUpdate);
        assertTable7UpdatableFieldsEquals(partialUpdatedTable7, getPersistedTable7(partialUpdatedTable7));
    }

    @Test
    @Transactional
    void patchNonExistingTable7() throws Exception {
        long databaseSizeBeforeUpdate = getRepositoryCount();
        table7.setId(longCount.incrementAndGet());
        ...
        restTable7MockMvc
            .perform(
                patch(ENTITY_API_URL_ID, table7.getId()).contentType("application/merge-patch+json").content(om.writeValueAsBytes(table7))
            )
            .andExpect(status().isBadRequest());
    ...
    @Test
    @Transactional
    void patchWithIdMismatchTable7() throws Exception {
        long databaseSizeBeforeUpdate = getRepositoryCount();
        table7.setId(longCount.incrementAndGet());
    ...
    @Test
    @Transactional
    void patchWithMissingIdPathParamTable7() throws Exception {
        long databaseSizeBeforeUpdate = getRepositoryCount();
        table7.setId(longCount.incrementAndGet());

        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restTable7MockMvc
            .perform(patch(ENTITY_API_URL).contentType("application/merge-patch+json").content(om.writeValueAsBytes(table7)))
            .andExpect(status().isMethodNotAllowed());
    ...
    @Test
    @Transactional
    void deleteTable7() throws Exception {
        // Initialize the database
        table7Repository.saveAndFlush(table7);
        ...
        // Delete the table7
        restTable7MockMvc
            .perform(delete(ENTITY_API_URL_ID, table7.getId()).accept(MediaType.APPLICATION_JSON))
    ...
    protected Table7 getPersistedTable7(Table7 table7) {
        return table7Repository.findById(table7.getId()).orElseThrow();
    }

    protected void assertPersistedTable7ToMatchAllProperties(Table7 expectedTable7) {
        assertTable7AllPropertiesEquals(expectedTable7, getPersistedTable7(expectedTable7));
    }

    protected void assertPersistedTable7ToMatchUpdatableProperties(Table7 expectedTable7) {
        assertTable7AllUpdatablePropertiesEquals(expectedTable7, getPersistedTable7(expectedTable7));
    }
}
