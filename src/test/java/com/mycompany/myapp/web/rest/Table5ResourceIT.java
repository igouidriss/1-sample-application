...
import static com.mycompany.myapp.domain.Table5Asserts.*;
...
/**
 * Integration tests for the {@link Table5Resource} REST controller.
 */
@IntegrationTest
@AutoConfigureMockMvc
@WithMockUser
class Table5ResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/table-5-s";
    ...
    @Autowired
    private MockMvc restTable5MockMvc;
     ...
     */
    public static Table5 createEntity(EntityManager em) {
     ...
     * if they test an entity which requires the current entity.
     */
    public static Table5 createUpdatedEntity(EntityManager em) {
        Table5 table5 = new Table5()
    ...
    void createTable5() throws Exception {
        ...
        // Create the Table5
        var returnedTable5 = om.readValue(
            restTable5MockMvc
                .perform(post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(table5)))
        ...
        // Validate the Table5 in the database
        assertIncrementedRepositoryCount(databaseSizeBeforeCreate);
        assertTable5UpdatableFieldsEquals(returnedTable5, getPersistedTable5(returnedTable5));
    }

    @Test
    @Transactional
    void createTable5WithExistingId() throws Exception {
        // Create the Table5 with an existing ID
        table5.setId(1L);
    ...
    @Test
    @Transactional
    void getAllTable5s() throws Exception {
        // Initialize the database
        table5Repository.saveAndFlush(table5);

        // Get all the table5List
        restTable5MockMvc
            .perform(get(ENTITY_API_URL + "?sort=id,desc"))
            .andExpect(status().isOk())
            .andExpect(content().contentType(MediaType.APPLICATION_JSON_VALUE))
            .andExpect(jsonPath("$.[*].id").value(hasItem(table5.getId().intValue())))
    ...
    @Test
    @Transactional
    void getTable5() throws Exception {
        // Initialize the database
        table5Repository.saveAndFlush(table5);

        // Get the table5
        restTable5MockMvc
            .perform(get(ENTITY_API_URL_ID, table5.getId()))
            .andExpect(status().isOk())
            .andExpect(content().contentType(MediaType.APPLICATION_JSON_VALUE))
            .andExpect(jsonPath("$.id").value(table5.getId().intValue()))
    ...
    @Test
    @Transactional
    void getNonExistingTable5() throws Exception {
        // Get the table5
        restTable5MockMvc.perform(get(ENTITY_API_URL_ID, Long.MAX_VALUE)).andExpect(status().isNotFound());
    }

    @Test
    @Transactional
    void putExistingTable5() throws Exception {
        // Initialize the database
        table5Repository.saveAndFlush(table5);
        ...
        // Update the table5
        Table5 updatedTable5 = table5Repository.findById(table5.getId()).orElseThrow();
        // Disconnect from session so that the updates on updatedTable5 are not directly saved in db
        em.detach(updatedTable5);
        updatedTable5
            .numLigne1(UPDATED_NUM_LIGNE_1)
            .resort2(UPDATED_RESORT_2)
            .resvNameId3(UPDATED_RESV_NAME_ID_3)
        ...
        restTable5MockMvc
            .perform(
                put(ENTITY_API_URL_ID, updatedTable5.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(om.writeValueAsBytes(updatedTable5))
            )
            .andExpect(status().isOk());

        // Validate the Table5 in the database
        assertSameRepositoryCount(databaseSizeBeforeUpdate);
        assertPersistedTable5ToMatchAllProperties(updatedTable5);
    }

    @Test
    @Transactional
    void putNonExistingTable5() throws Exception {
        long databaseSizeBeforeUpdate = getRepositoryCount();
        table5.setId(longCount.incrementAndGet());

        // If the entity doesn't have an ID, it will throw BadRequestAlertException
        restTable5MockMvc
            .perform(put(ENTITY_API_URL_ID, table5.getId()).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(table5)))
            .andExpect(status().isBadRequest());
    ...
    @Test
    @Transactional
    void putWithIdMismatchTable5() throws Exception {
        long databaseSizeBeforeUpdate = getRepositoryCount();
        table5.setId(longCount.incrementAndGet());
        ...
        restTable5MockMvc
            .perform(
                put(ENTITY_API_URL_ID, longCount.incrementAndGet())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(om.writeValueAsBytes(table5))
            )
            .andExpect(status().isBadRequest());
    ...
    @Test
    @Transactional
    void putWithMissingIdPathParamTable5() throws Exception {
        long databaseSizeBeforeUpdate = getRepositoryCount();
        table5.setId(longCount.incrementAndGet());

        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restTable5MockMvc
            .perform(put(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(table5)))
    ...
    @Test
    @Transactional
    void partialUpdateTable5WithPatch() throws Exception {
        // Initialize the database
        table5Repository.saveAndFlush(table5);

        long databaseSizeBeforeUpdate = getRepositoryCount();

        // Update the table5 using partial update
        Table5 partialUpdatedTable5 = new Table5();
        partialUpdatedTable5.setId(table5.getId());

        partialUpdatedTable5
            .resort2(UPDATED_RESORT_2)
            .clientOId4(UPDATED_CLIENT_O_ID_4)
            .typeChb5(UPDATED_TYPE_CHB_5)
            .confirmationNo6(UPDATED_CONFIRMATION_NO_6)
        ...
        restTable5MockMvc
            .perform(
                patch(ENTITY_API_URL_ID, partialUpdatedTable5.getId())
                    .contentType("application/merge-patch+json")
                    .content(om.writeValueAsBytes(partialUpdatedTable5))
            )
            .andExpect(status().isOk());
        ...
        assertSameRepositoryCount(databaseSizeBeforeUpdate);
        assertTable5UpdatableFieldsEquals(createUpdateProxyForBean(partialUpdatedTable5, table5), getPersistedTable5(table5));
    }

    @Test
    @Transactional
    void fullUpdateTable5WithPatch() throws Exception {
        // Initialize the database
        table5Repository.saveAndFlush(table5);
        ...
        assertSameRepositoryCount(databaseSizeBeforeUpdate);
        assertTable5UpdatableFieldsEquals(partialUpdatedTable5, getPersistedTable5(partialUpdatedTable5));
    }

    @Test
    @Transactional
    void patchNonExistingTable5() throws Exception {
        long databaseSizeBeforeUpdate = getRepositoryCount();
        table5.setId(longCount.incrementAndGet());
        ...
        restTable5MockMvc
            .perform(
                patch(ENTITY_API_URL_ID, table5.getId()).contentType("application/merge-patch+json").content(om.writeValueAsBytes(table5))
            )
            .andExpect(status().isBadRequest());
    ...
    @Test
    @Transactional
    void patchWithIdMismatchTable5() throws Exception {
        long databaseSizeBeforeUpdate = getRepositoryCount();
        table5.setId(longCount.incrementAndGet());
    ...
    @Test
    @Transactional
    void patchWithMissingIdPathParamTable5() throws Exception {
        long databaseSizeBeforeUpdate = getRepositoryCount();
        table5.setId(longCount.incrementAndGet());

        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restTable5MockMvc
            .perform(patch(ENTITY_API_URL).contentType("application/merge-patch+json").content(om.writeValueAsBytes(table5)))
            .andExpect(status().isMethodNotAllowed());
    ...
    @Test
    @Transactional
    void deleteTable5() throws Exception {
        // Initialize the database
        table5Repository.saveAndFlush(table5);
        ...
        // Delete the table5
        restTable5MockMvc
            .perform(delete(ENTITY_API_URL_ID, table5.getId()).accept(MediaType.APPLICATION_JSON))
    ...
    protected Table5 getPersistedTable5(Table5 table5) {
        return table5Repository.findById(table5.getId()).orElseThrow();
    }

    protected void assertPersistedTable5ToMatchAllProperties(Table5 expectedTable5) {
        assertTable5AllPropertiesEquals(expectedTable5, getPersistedTable5(expectedTable5));
    }

    protected void assertPersistedTable5ToMatchUpdatableProperties(Table5 expectedTable5) {
        assertTable5AllUpdatablePropertiesEquals(expectedTable5, getPersistedTable5(expectedTable5));
    }
}
