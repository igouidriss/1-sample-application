...
import static com.mycompany.myapp.domain.Table3Asserts.*;
...
/**
 * Integration tests for the {@link Table3Resource} REST controller.
 */
@IntegrationTest
@AutoConfigureMockMvc
@WithMockUser
class Table3ResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/table-3-s";
    ...
    @Autowired
    private MockMvc restTable3MockMvc;
     ...
     */
    public static Table3 createEntity(EntityManager em) {
     ...
     * if they test an entity which requires the current entity.
     */
    public static Table3 createUpdatedEntity(EntityManager em) {
        Table3 table3 = new Table3()
    ...
    void createTable3() throws Exception {
        ...
        // Create the Table3
        var returnedTable3 = om.readValue(
            restTable3MockMvc
                .perform(post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(table3)))
        ...
        // Validate the Table3 in the database
        assertIncrementedRepositoryCount(databaseSizeBeforeCreate);
        assertTable3UpdatableFieldsEquals(returnedTable3, getPersistedTable3(returnedTable3));
    }

    @Test
    @Transactional
    void createTable3WithExistingId() throws Exception {
        // Create the Table3 with an existing ID
        table3.setId(1L);
    ...
    @Test
    @Transactional
    void getAllTable3s() throws Exception {
        // Initialize the database
        table3Repository.saveAndFlush(table3);

        // Get all the table3List
        restTable3MockMvc
            .perform(get(ENTITY_API_URL + "?sort=id,desc"))
            .andExpect(status().isOk())
            .andExpect(content().contentType(MediaType.APPLICATION_JSON_VALUE))
            .andExpect(jsonPath("$.[*].id").value(hasItem(table3.getId().intValue())))
    ...
    @Test
    @Transactional
    void getTable3() throws Exception {
        // Initialize the database
        table3Repository.saveAndFlush(table3);

        // Get the table3
        restTable3MockMvc
            .perform(get(ENTITY_API_URL_ID, table3.getId()))
            .andExpect(status().isOk())
            .andExpect(content().contentType(MediaType.APPLICATION_JSON_VALUE))
            .andExpect(jsonPath("$.id").value(table3.getId().intValue()))
    ...
    @Test
    @Transactional
    void getNonExistingTable3() throws Exception {
        // Get the table3
        restTable3MockMvc.perform(get(ENTITY_API_URL_ID, Long.MAX_VALUE)).andExpect(status().isNotFound());
    }

    @Test
    @Transactional
    void putExistingTable3() throws Exception {
        // Initialize the database
        table3Repository.saveAndFlush(table3);
        ...
        // Update the table3
        Table3 updatedTable3 = table3Repository.findById(table3.getId()).orElseThrow();
        // Disconnect from session so that the updates on updatedTable3 are not directly saved in db
        em.detach(updatedTable3);
        updatedTable3
            .numLigne1(UPDATED_NUM_LIGNE_1)
            .resort2(UPDATED_RESORT_2)
            .resvNameId3(UPDATED_RESV_NAME_ID_3)
        ...
        restTable3MockMvc
            .perform(
                put(ENTITY_API_URL_ID, updatedTable3.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(om.writeValueAsBytes(updatedTable3))
            )
            .andExpect(status().isOk());

        // Validate the Table3 in the database
        assertSameRepositoryCount(databaseSizeBeforeUpdate);
        assertPersistedTable3ToMatchAllProperties(updatedTable3);
    }

    @Test
    @Transactional
    void putNonExistingTable3() throws Exception {
        long databaseSizeBeforeUpdate = getRepositoryCount();
        table3.setId(longCount.incrementAndGet());

        // If the entity doesn't have an ID, it will throw BadRequestAlertException
        restTable3MockMvc
            .perform(put(ENTITY_API_URL_ID, table3.getId()).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(table3)))
            .andExpect(status().isBadRequest());
    ...
    @Test
    @Transactional
    void putWithIdMismatchTable3() throws Exception {
        long databaseSizeBeforeUpdate = getRepositoryCount();
        table3.setId(longCount.incrementAndGet());
        ...
        restTable3MockMvc
            .perform(
                put(ENTITY_API_URL_ID, longCount.incrementAndGet())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(om.writeValueAsBytes(table3))
            )
            .andExpect(status().isBadRequest());
    ...
    @Test
    @Transactional
    void putWithMissingIdPathParamTable3() throws Exception {
        long databaseSizeBeforeUpdate = getRepositoryCount();
        table3.setId(longCount.incrementAndGet());

        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restTable3MockMvc
            .perform(put(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(table3)))
    ...
    @Test
    @Transactional
    void partialUpdateTable3WithPatch() throws Exception {
        // Initialize the database
        table3Repository.saveAndFlush(table3);

        long databaseSizeBeforeUpdate = getRepositoryCount();

        // Update the table3 using partial update
        Table3 partialUpdatedTable3 = new Table3();
        partialUpdatedTable3.setId(table3.getId());

        partialUpdatedTable3
            .numLigne1(UPDATED_NUM_LIGNE_1)
            .resvNameId3(UPDATED_RESV_NAME_ID_3)
            .parentResvNameId9(UPDATED_PARENT_RESV_NAME_ID_9)
            .agenceId11(UPDATED_AGENCE_ID_11)
        ...
        restTable3MockMvc
            .perform(
                patch(ENTITY_API_URL_ID, partialUpdatedTable3.getId())
                    .contentType("application/merge-patch+json")
                    .content(om.writeValueAsBytes(partialUpdatedTable3))
            )
            .andExpect(status().isOk());
        ...
        assertSameRepositoryCount(databaseSizeBeforeUpdate);
        assertTable3UpdatableFieldsEquals(createUpdateProxyForBean(partialUpdatedTable3, table3), getPersistedTable3(table3));
    }

    @Test
    @Transactional
    void fullUpdateTable3WithPatch() throws Exception {
        // Initialize the database
        table3Repository.saveAndFlush(table3);
        ...
        assertSameRepositoryCount(databaseSizeBeforeUpdate);
        assertTable3UpdatableFieldsEquals(partialUpdatedTable3, getPersistedTable3(partialUpdatedTable3));
    }

    @Test
    @Transactional
    void patchNonExistingTable3() throws Exception {
        long databaseSizeBeforeUpdate = getRepositoryCount();
        table3.setId(longCount.incrementAndGet());
        ...
        restTable3MockMvc
            .perform(
                patch(ENTITY_API_URL_ID, table3.getId()).contentType("application/merge-patch+json").content(om.writeValueAsBytes(table3))
            )
            .andExpect(status().isBadRequest());
    ...
    @Test
    @Transactional
    void patchWithIdMismatchTable3() throws Exception {
        long databaseSizeBeforeUpdate = getRepositoryCount();
        table3.setId(longCount.incrementAndGet());
    ...
    @Test
    @Transactional
    void patchWithMissingIdPathParamTable3() throws Exception {
        long databaseSizeBeforeUpdate = getRepositoryCount();
        table3.setId(longCount.incrementAndGet());

        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restTable3MockMvc
            .perform(patch(ENTITY_API_URL).contentType("application/merge-patch+json").content(om.writeValueAsBytes(table3)))
            .andExpect(status().isMethodNotAllowed());
    ...
    @Test
    @Transactional
    void deleteTable3() throws Exception {
        // Initialize the database
        table3Repository.saveAndFlush(table3);
        ...
        // Delete the table3
        restTable3MockMvc
            .perform(delete(ENTITY_API_URL_ID, table3.getId()).accept(MediaType.APPLICATION_JSON))
    ...
    protected Table3 getPersistedTable3(Table3 table3) {
        return table3Repository.findById(table3.getId()).orElseThrow();
    }

    protected void assertPersistedTable3ToMatchAllProperties(Table3 expectedTable3) {
        assertTable3AllPropertiesEquals(expectedTable3, getPersistedTable3(expectedTable3));
    }

    protected void assertPersistedTable3ToMatchUpdatableProperties(Table3 expectedTable3) {
        assertTable3AllUpdatablePropertiesEquals(expectedTable3, getPersistedTable3(expectedTable3));
    }
}
