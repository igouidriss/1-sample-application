...
import static com.mycompany.myapp.domain.Table4Asserts.*;
...
/**
 * Integration tests for the {@link Table4Resource} REST controller.
 */
@IntegrationTest
@AutoConfigureMockMvc
@WithMockUser
class Table4ResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/table-4-s";
    ...
    @Autowired
    private MockMvc restTable4MockMvc;
     ...
     */
    public static Table4 createEntity(EntityManager em) {
     ...
     * if they test an entity which requires the current entity.
     */
    public static Table4 createUpdatedEntity(EntityManager em) {
        Table4 table4 = new Table4()
    ...
    void createTable4() throws Exception {
        ...
        // Create the Table4
        var returnedTable4 = om.readValue(
            restTable4MockMvc
                .perform(post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(table4)))
        ...
        // Validate the Table4 in the database
        assertIncrementedRepositoryCount(databaseSizeBeforeCreate);
        assertTable4UpdatableFieldsEquals(returnedTable4, getPersistedTable4(returnedTable4));
    }

    @Test
    @Transactional
    void createTable4WithExistingId() throws Exception {
        // Create the Table4 with an existing ID
        table4.setId(1L);
    ...
    @Test
    @Transactional
    void getAllTable4s() throws Exception {
        // Initialize the database
        table4Repository.saveAndFlush(table4);

        // Get all the table4List
        restTable4MockMvc
            .perform(get(ENTITY_API_URL + "?sort=id,desc"))
            .andExpect(status().isOk())
            .andExpect(content().contentType(MediaType.APPLICATION_JSON_VALUE))
            .andExpect(jsonPath("$.[*].id").value(hasItem(table4.getId().intValue())))
    ...
    @Test
    @Transactional
    void getTable4() throws Exception {
        // Initialize the database
        table4Repository.saveAndFlush(table4);

        // Get the table4
        restTable4MockMvc
            .perform(get(ENTITY_API_URL_ID, table4.getId()))
            .andExpect(status().isOk())
            .andExpect(content().contentType(MediaType.APPLICATION_JSON_VALUE))
            .andExpect(jsonPath("$.id").value(table4.getId().intValue()))
    ...
    @Test
    @Transactional
    void getNonExistingTable4() throws Exception {
        // Get the table4
        restTable4MockMvc.perform(get(ENTITY_API_URL_ID, Long.MAX_VALUE)).andExpect(status().isNotFound());
    }

    @Test
    @Transactional
    void putExistingTable4() throws Exception {
        // Initialize the database
        table4Repository.saveAndFlush(table4);
        ...
        // Update the table4
        Table4 updatedTable4 = table4Repository.findById(table4.getId()).orElseThrow();
        // Disconnect from session so that the updates on updatedTable4 are not directly saved in db
        em.detach(updatedTable4);
        updatedTable4
            .numLigne1(UPDATED_NUM_LIGNE_1)
            .resort2(UPDATED_RESORT_2)
            .resvNameId3(UPDATED_RESV_NAME_ID_3)
        ...
        restTable4MockMvc
            .perform(
                put(ENTITY_API_URL_ID, updatedTable4.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(om.writeValueAsBytes(updatedTable4))
            )
            .andExpect(status().isOk());

        // Validate the Table4 in the database
        assertSameRepositoryCount(databaseSizeBeforeUpdate);
        assertPersistedTable4ToMatchAllProperties(updatedTable4);
    }

    @Test
    @Transactional
    void putNonExistingTable4() throws Exception {
        long databaseSizeBeforeUpdate = getRepositoryCount();
        table4.setId(longCount.incrementAndGet());

        // If the entity doesn't have an ID, it will throw BadRequestAlertException
        restTable4MockMvc
            .perform(put(ENTITY_API_URL_ID, table4.getId()).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(table4)))
            .andExpect(status().isBadRequest());
    ...
    @Test
    @Transactional
    void putWithIdMismatchTable4() throws Exception {
        long databaseSizeBeforeUpdate = getRepositoryCount();
        table4.setId(longCount.incrementAndGet());
        ...
        restTable4MockMvc
            .perform(
                put(ENTITY_API_URL_ID, longCount.incrementAndGet())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(om.writeValueAsBytes(table4))
            )
            .andExpect(status().isBadRequest());
    ...
    @Test
    @Transactional
    void putWithMissingIdPathParamTable4() throws Exception {
        long databaseSizeBeforeUpdate = getRepositoryCount();
        table4.setId(longCount.incrementAndGet());

        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restTable4MockMvc
            .perform(put(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(table4)))
    ...
    @Test
    @Transactional
    void partialUpdateTable4WithPatch() throws Exception {
        // Initialize the database
        table4Repository.saveAndFlush(table4);

        long databaseSizeBeforeUpdate = getRepositoryCount();

        // Update the table4 using partial update
        Table4 partialUpdatedTable4 = new Table4();
        partialUpdatedTable4.setId(table4.getId());

        partialUpdatedTable4
            .numLigne1(UPDATED_NUM_LIGNE_1)
            .resort2(UPDATED_RESORT_2)
            .resvNameId3(UPDATED_RESV_NAME_ID_3)
            .typeChb5(UPDATED_TYPE_CHB_5)
        ...
        restTable4MockMvc
            .perform(
                patch(ENTITY_API_URL_ID, partialUpdatedTable4.getId())
                    .contentType("application/merge-patch+json")
                    .content(om.writeValueAsBytes(partialUpdatedTable4))
            )
            .andExpect(status().isOk());
        ...
        assertSameRepositoryCount(databaseSizeBeforeUpdate);
        assertTable4UpdatableFieldsEquals(createUpdateProxyForBean(partialUpdatedTable4, table4), getPersistedTable4(table4));
    }

    @Test
    @Transactional
    void fullUpdateTable4WithPatch() throws Exception {
        // Initialize the database
        table4Repository.saveAndFlush(table4);
        ...
        assertSameRepositoryCount(databaseSizeBeforeUpdate);
        assertTable4UpdatableFieldsEquals(partialUpdatedTable4, getPersistedTable4(partialUpdatedTable4));
    }

    @Test
    @Transactional
    void patchNonExistingTable4() throws Exception {
        long databaseSizeBeforeUpdate = getRepositoryCount();
        table4.setId(longCount.incrementAndGet());
        ...
        restTable4MockMvc
            .perform(
                patch(ENTITY_API_URL_ID, table4.getId()).contentType("application/merge-patch+json").content(om.writeValueAsBytes(table4))
            )
            .andExpect(status().isBadRequest());
    ...
    @Test
    @Transactional
    void patchWithIdMismatchTable4() throws Exception {
        long databaseSizeBeforeUpdate = getRepositoryCount();
        table4.setId(longCount.incrementAndGet());
    ...
    @Test
    @Transactional
    void patchWithMissingIdPathParamTable4() throws Exception {
        long databaseSizeBeforeUpdate = getRepositoryCount();
        table4.setId(longCount.incrementAndGet());

        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restTable4MockMvc
            .perform(patch(ENTITY_API_URL).contentType("application/merge-patch+json").content(om.writeValueAsBytes(table4)))
            .andExpect(status().isMethodNotAllowed());
    ...
    @Test
    @Transactional
    void deleteTable4() throws Exception {
        // Initialize the database
        table4Repository.saveAndFlush(table4);
        ...
        // Delete the table4
        restTable4MockMvc
            .perform(delete(ENTITY_API_URL_ID, table4.getId()).accept(MediaType.APPLICATION_JSON))
    ...
    protected Table4 getPersistedTable4(Table4 table4) {
        return table4Repository.findById(table4.getId()).orElseThrow();
    }

    protected void assertPersistedTable4ToMatchAllProperties(Table4 expectedTable4) {
        assertTable4AllPropertiesEquals(expectedTable4, getPersistedTable4(expectedTable4));
    }

    protected void assertPersistedTable4ToMatchUpdatableProperties(Table4 expectedTable4) {
        assertTable4AllUpdatablePropertiesEquals(expectedTable4, getPersistedTable4(expectedTable4));
    }
}
