...
import { ITable6 } from 'app/shared/model/table-6.model';
import { getEntity, updateEntity, createEntity, reset } from './table-6.reducer';

export const Table6Update = () => {
  ...
  const loading = useAppSelector(state => state.table6.loading);
  const updating = useAppSelector(state => state.table6.updating);
  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="App.table6.home.createOrEditLabel" data-cy="Table6CreateUpdateHeading">
            <Translate contentKey="App.table6.home.createOrEditLabel">Create or edit a Table6</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('App.table6.numLigne1')}
                id="table-6-numLigne1"
                name="numLigne1"
                data-cy="numLigne1"
                type="text"
              />
              <ValidatedField label={translate('App.table6.resort2')} id="table-6-resort2" name="resort2" data-cy="resort2" type="text" />
              <ValidatedField
                label={translate('App.table6.resvNameId3')}
                id="table-6-resvNameId3"
                name="resvNameId3"
                data-cy="resvNameId3"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.clientOId4')}
                id="table-6-clientOId4"
                name="clientOId4"
                data-cy="clientOId4"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.typeChb5')}
                id="table-6-typeChb5"
                name="typeChb5"
                data-cy="typeChb5"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.confirmationNo6')}
                id="table-6-confirmationNo6"
                name="confirmationNo6"
                data-cy="confirmationNo6"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.clientMdmId7')}
                id="table-6-clientMdmId7"
                name="clientMdmId7"
                data-cy="clientMdmId7"
                type="text"
              />
              <ValidatedField label={translate('App.table6.nameId8')} id="table-6-nameId8" name="nameId8" data-cy="nameId8" type="text" />
              <ValidatedField
                label={translate('App.table6.parentResvNameId9')}
                id="table-6-parentResvNameId9"
                name="parentResvNameId9"
                data-cy="parentResvNameId9"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.contactId10')}
                id="table-6-contactId10"
                name="contactId10"
                data-cy="contactId10"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.agenceId11')}
                id="table-6-agenceId11"
                name="agenceId11"
                data-cy="agenceId11"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.agenceNom12')}
                id="table-6-agenceNom12"
                name="agenceNom12"
                data-cy="agenceNom12"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.societeId13')}
                id="table-6-societeId13"
                name="societeId13"
                data-cy="societeId13"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.groupeId14')}
                id="table-6-groupeId14"
                name="groupeId14"
                data-cy="groupeId14"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.numBloc15')}
                id="table-6-numBloc15"
                name="numBloc15"
                data-cy="numBloc15"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.typeResv16')}
                id="table-6-typeResv16"
                name="typeResv16"
                data-cy="typeResv16"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.statutResv17')}
                id="table-6-statutResv17"
                name="statutResv17"
                data-cy="statutResv17"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.dateDebutResv18')}
                id="table-6-dateDebutResv18"
                name="dateDebutResv18"
                data-cy="dateDebutResv18"
                type="date"
              />
              <ValidatedField
                label={translate('App.table6.dateFinResv19')}
                id="table-6-dateFinResv19"
                name="dateFinResv19"
                data-cy="dateFinResv19"
                type="date"
              />
              <ValidatedField
                label={translate('App.table6.truncDateDebutResv20')}
                id="table-6-truncDateDebutResv20"
                name="truncDateDebutResv20"
                data-cy="truncDateDebutResv20"
                type="date"
              />
              <ValidatedField
                label={translate('App.table6.truncDateFinResv21')}
                id="table-6-truncDateFinResv21"
                name="truncDateFinResv21"
                data-cy="truncDateFinResv21"
                type="date"
              />
              <ValidatedField
                label={translate('App.table6.dateAnnResv22')}
                id="table-6-dateAnnResv22"
                name="dateAnnResv22"
                data-cy="dateAnnResv22"
                type="date"
              />
              <ValidatedField
                label={translate('App.table6.pseudoRoomYn23')}
                id="table-6-pseudoRoomYn23"
                name="pseudoRoomYn23"
                data-cy="pseudoRoomYn23"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.createurResv24')}
                id="table-6-createurResv24"
                name="createurResv24"
                data-cy="createurResv24"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.nomCreateurResv25')}
                id="table-6-nomCreateurResv25"
                name="nomCreateurResv25"
                data-cy="nomCreateurResv25"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.codeGarantie26')}
                id="table-6-codeGarantie26"
                name="codeGarantie26"
                data-cy="codeGarantie26"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.flgDed27')}
                id="table-6-flgDed27"
                name="flgDed27"
                data-cy="flgDed27"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.codePays28')}
                id="table-6-codePays28"
                name="codePays28"
                data-cy="codePays28"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.libPays29')}
                id="table-6-libPays29"
                name="libPays29"
                data-cy="libPays29"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.codeNationalite30')}
                id="table-6-codeNationalite30"
                name="codeNationalite30"
                data-cy="codeNationalite30"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.libNationalite31')}
                id="table-6-libNationalite31"
                name="libNationalite31"
                data-cy="libNationalite31"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.codeSource32')}
                id="table-6-codeSource32"
                name="codeSource32"
                data-cy="codeSource32"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.libSource33')}
                id="table-6-libSource33"
                name="libSource33"
                data-cy="libSource33"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.codeGrandSource34')}
                id="table-6-codeGrandSource34"
                name="codeGrandSource34"
                data-cy="codeGrandSource34"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.codeOrigine35')}
                id="table-6-codeOrigine35"
                name="codeOrigine35"
                data-cy="codeOrigine35"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.libOrigine36')}
                id="table-6-libOrigine36"
                name="libOrigine36"
                data-cy="libOrigine36"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.codeMarche37')}
                id="table-6-codeMarche37"
                name="codeMarche37"
                data-cy="codeMarche37"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.libMarche38')}
                id="table-6-libMarche38"
                name="libMarche38"
                data-cy="libMarche38"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.codeGrandMarche39')}
                id="table-6-codeGrandMarche39"
                name="codeGrandMarche39"
                data-cy="codeGrandMarche39"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.libGrandMarche40')}
                id="table-6-libGrandMarche40"
                name="libGrandMarche40"
                data-cy="libGrandMarche40"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.codePrix41')}
                id="table-6-codePrix41"
                name="codePrix41"
                data-cy="codePrix41"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.categPrix42')}
                id="table-6-categPrix42"
                name="categPrix42"
                data-cy="categPrix42"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.libPrix43')}
                id="table-6-libPrix43"
                name="libPrix43"
                data-cy="libPrix43"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.numChb44')}
                id="table-6-numChb44"
                name="numChb44"
                data-cy="numChb44"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.descriptionTypeChb45')}
                id="table-6-descriptionTypeChb45"
                name="descriptionTypeChb45"
                data-cy="descriptionTypeChb45"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.codeTypeChb46')}
                id="table-6-codeTypeChb46"
                name="codeTypeChb46"
                data-cy="codeTypeChb46"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.classChb47')}
                id="table-6-classChb47"
                name="classChb47"
                data-cy="classChb47"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.caractChb48')}
                id="table-6-caractChb48"
                name="caractChb48"
                data-cy="caractChb48"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.typeChbDeReservation49')}
                id="table-6-typeChbDeReservation49"
                name="typeChbDeReservation49"
                data-cy="typeChbDeReservation49"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.descriptionTypeChbDeResv50')}
                id="table-6-descriptionTypeChbDeResv50"
                name="descriptionTypeChbDeResv50"
                data-cy="descriptionTypeChbDeResv50"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.codeTypeChbDeResv51')}
                id="table-6-codeTypeChbDeResv51"
                name="codeTypeChbDeResv51"
                data-cy="codeTypeChbDeResv51"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.statutDeReservation52')}
                id="table-6-statutDeReservation52"
                name="statutDeReservation52"
                data-cy="statutDeReservation52"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.circuitDistribution53')}
                id="table-6-circuitDistribution53"
                name="circuitDistribution53"
                data-cy="circuitDistribution53"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.circuitDistribUserRegroup54')}
                id="table-6-circuitDistribUserRegroup54"
                name="circuitDistribUserRegroup54"
                data-cy="circuitDistribUserRegroup54"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.numCrs55')}
                id="table-6-numCrs55"
                name="numCrs55"
                data-cy="numCrs55"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.typeRefCrs56')}
                id="table-6-typeRefCrs56"
                name="typeRefCrs56"
                data-cy="typeRefCrs56"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.crsInsertDate57')}
                id="table-6-crsInsertDate57"
                name="crsInsertDate57"
                data-cy="crsInsertDate57"
                type="date"
              />
              <ValidatedField
                label={translate('App.table6.dateCreaResv58')}
                id="table-6-dateCreaResv58"
                name="dateCreaResv58"
                data-cy="dateCreaResv58"
                type="date"
              />
              <ValidatedField
                label={translate('App.table6.datePremier59')}
                id="table-6-datePremier59"
                name="datePremier59"
                data-cy="datePremier59"
                type="date"
              />
              <ValidatedField
                label={translate('App.table6.statutPremier60')}
                id="table-6-statutPremier60"
                name="statutPremier60"
                data-cy="statutPremier60"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.dateDernier61')}
                id="table-6-dateDernier61"
                name="dateDernier61"
                data-cy="dateDernier61"
                type="date"
              />
              <ValidatedField
                label={translate('App.table6.statutDernier62')}
                id="table-6-statutDernier62"
                name="statutDernier62"
                data-cy="statutDernier62"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.dateDernierPseudo63')}
                id="table-6-dateDernierPseudo63"
                name="dateDernierPseudo63"
                data-cy="dateDernierPseudo63"
                type="date"
              />
              <ValidatedField
                label={translate('App.table6.statutDernierPseudo64')}
                id="table-6-statutDernierPseudo64"
                name="statutDernierPseudo64"
                data-cy="statutDernierPseudo64"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.diffDtCreaAnn65')}
                id="table-6-diffDtCreaAnn65"
                name="diffDtCreaAnn65"
                data-cy="diffDtCreaAnn65"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.diffDtArrAnn66')}
                id="table-6-diffDtArrAnn66"
                name="diffDtArrAnn66"
                data-cy="diffDtArrAnn66"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.leadtime67')}
                id="table-6-leadtime67"
                name="leadtime67"
                data-cy="leadtime67"
                type="text"
              />
              <ValidatedField label={translate('App.table6.los68')} id="table-6-los68" name="los68" data-cy="los68" type="text" />
              <ValidatedField
                label={translate('App.table6.occupantsGroupe69')}
                id="table-6-occupantsGroupe69"
                name="occupantsGroupe69"
                data-cy="occupantsGroupe69"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.nbNuitee70')}
                id="table-6-nbNuitee70"
                name="nbNuitee70"
                data-cy="nbNuitee70"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.nbNuiteeNnDed71')}
                id="table-6-nbNuiteeNnDed71"
                name="nbNuiteeNnDed71"
                data-cy="nbNuiteeNnDed71"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.nbResvAnn72')}
                id="table-6-nbResvAnn72"
                name="nbResvAnn72"
                data-cy="nbResvAnn72"
                type="text"
              />
              <ValidatedField label={translate('App.table6.nbAdu73')} id="table-6-nbAdu73" name="nbAdu73" data-cy="nbAdu73" type="text" />
              <ValidatedField label={translate('App.table6.nbEnf74')} id="table-6-nbEnf74" name="nbEnf74" data-cy="nbEnf74" type="text" />
              <ValidatedField
                label={translate('App.table6.nbPersDayU75')}
                id="table-6-nbPersDayU75"
                name="nbPersDayU75"
                data-cy="nbPersDayU75"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.nbPersArr76')}
                id="table-6-nbPersArr76"
                name="nbPersArr76"
                data-cy="nbPersArr76"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.nbPersDep77')}
                id="table-6-nbPersDep77"
                name="nbPersDep77"
                data-cy="nbPersDep77"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.nbPersAnn78')}
                id="table-6-nbPersAnn78"
                name="nbPersAnn78"
                data-cy="nbPersAnn78"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.nbPersNoshow79')}
                id="table-6-nbPersNoshow79"
                name="nbPersNoshow79"
                data-cy="nbPersNoshow79"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.nbChbDayU80')}
                id="table-6-nbChbDayU80"
                name="nbChbDayU80"
                data-cy="nbChbDayU80"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.nbChbArr81')}
                id="table-6-nbChbArr81"
                name="nbChbArr81"
                data-cy="nbChbArr81"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.nbChbDep82')}
                id="table-6-nbChbDep82"
                name="nbChbDep82"
                data-cy="nbChbDep82"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.nbChbAnn83')}
                id="table-6-nbChbAnn83"
                name="nbChbAnn83"
                data-cy="nbChbAnn83"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.nbChbNoshow84')}
                id="table-6-nbChbNoshow84"
                name="nbChbNoshow84"
                data-cy="nbChbNoshow84"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.revenuNetChambre85')}
                id="table-6-revenuNetChambre85"
                name="revenuNetChambre85"
                data-cy="revenuNetChambre85"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.revenuTaxeChambre86')}
                id="table-6-revenuTaxeChambre86"
                name="revenuTaxeChambre86"
                data-cy="revenuTaxeChambre86"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.revenuNetChambreGlobal87')}
                id="table-6-revenuNetChambreGlobal87"
                name="revenuNetChambreGlobal87"
                data-cy="revenuNetChambreGlobal87"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.revenuTaxeChambreGlobal88')}
                id="table-6-revenuTaxeChambreGlobal88"
                name="revenuTaxeChambreGlobal88"
                data-cy="revenuTaxeChambreGlobal88"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.revenuNetBq89')}
                id="table-6-revenuNetBq89"
                name="revenuNetBq89"
                data-cy="revenuNetBq89"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.revenuTaxeBq90')}
                id="table-6-revenuTaxeBq90"
                name="revenuTaxeBq90"
                data-cy="revenuTaxeBq90"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.revenuNetBqGlobal91')}
                id="table-6-revenuNetBqGlobal91"
                name="revenuNetBqGlobal91"
                data-cy="revenuNetBqGlobal91"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.revenuTaxeBqGlobal92')}
                id="table-6-revenuTaxeBqGlobal92"
                name="revenuTaxeBqGlobal92"
                data-cy="revenuTaxeBqGlobal92"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.revenuNetExtra93')}
                id="table-6-revenuNetExtra93"
                name="revenuNetExtra93"
                data-cy="revenuNetExtra93"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.revenuTaxeExtra94')}
                id="table-6-revenuTaxeExtra94"
                name="revenuTaxeExtra94"
                data-cy="revenuTaxeExtra94"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.revenuNetExtraGlobal95')}
                id="table-6-revenuNetExtraGlobal95"
                name="revenuNetExtraGlobal95"
                data-cy="revenuNetExtraGlobal95"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.revenuTaxeExtraGlobal96')}
                id="table-6-revenuTaxeExtraGlobal96"
                name="revenuTaxeExtraGlobal96"
                data-cy="revenuTaxeExtraGlobal96"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.revenuNetTotal97')}
                id="table-6-revenuNetTotal97"
                name="revenuNetTotal97"
                data-cy="revenuNetTotal97"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.revenuTaxeTotal98')}
                id="table-6-revenuTaxeTotal98"
                name="revenuTaxeTotal98"
                data-cy="revenuTaxeTotal98"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.revenuNetTotalGlobal99')}
                id="table-6-revenuNetTotalGlobal99"
                name="revenuNetTotalGlobal99"
                data-cy="revenuNetTotalGlobal99"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.revenuTaxeTotalGlobal100')}
                id="table-6-revenuTaxeTotalGlobal100"
                name="revenuTaxeTotalGlobal100"
                data-cy="revenuTaxeTotalGlobal100"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.prodRevenuChambre101')}
                id="table-6-prodRevenuChambre101"
                name="prodRevenuChambre101"
                data-cy="prodRevenuChambre101"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.prodRevenuBq102')}
                id="table-6-prodRevenuBq102"
                name="prodRevenuBq102"
                data-cy="prodRevenuBq102"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.prodRevenuExtra103')}
                id="table-6-prodRevenuExtra103"
                name="prodRevenuExtra103"
                data-cy="prodRevenuExtra103"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.prodRevenuTotal104')}
                id="table-6-prodRevenuTotal104"
                name="prodRevenuTotal104"
                data-cy="prodRevenuTotal104"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.prodChambreNbNuitees105')}
                id="table-6-prodChambreNbNuitees105"
                name="prodChambreNbNuitees105"
                data-cy="prodChambreNbNuitees105"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.techCreateDate106')}
                id="table-6-techCreateDate106"
                name="techCreateDate106"
                data-cy="techCreateDate106"
                type="date"
              />
              <ValidatedField
                label={translate('App.table6.techUpdateDate107')}
                id="table-6-techUpdateDate107"
                name="techUpdateDate107"
                data-cy="techUpdateDate107"
                type="date"
              />
              <ValidatedField
                label={translate('App.table6.numLigne108')}
                id="table-6-numLigne108"
                name="numLigne108"
                data-cy="numLigne108"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.resort109')}
                id="table-6-resort109"
                name="resort109"
                data-cy="resort109"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.resvNameId110')}
                id="table-6-resvNameId110"
                name="resvNameId110"
                data-cy="resvNameId110"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.clientOId111')}
                id="table-6-clientOId111"
                name="clientOId111"
                data-cy="clientOId111"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.typeChb112')}
                id="table-6-typeChb112"
                name="typeChb112"
                data-cy="typeChb112"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.confirmationNo113')}
                id="table-6-confirmationNo113"
                name="confirmationNo113"
                data-cy="confirmationNo113"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.clientMdmId114')}
                id="table-6-clientMdmId114"
                name="clientMdmId114"
                data-cy="clientMdmId114"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.nameId115')}
                id="table-6-nameId115"
                name="nameId115"
                data-cy="nameId115"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.parentResvNameId116')}
                id="table-6-parentResvNameId116"
                name="parentResvNameId116"
                data-cy="parentResvNameId116"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.contactId117')}
                id="table-6-contactId117"
                name="contactId117"
                data-cy="contactId117"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.agenceId118')}
                id="table-6-agenceId118"
                name="agenceId118"
                data-cy="agenceId118"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.agenceNom119')}
                id="table-6-agenceNom119"
                name="agenceNom119"
                data-cy="agenceNom119"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.societeId120')}
                id="table-6-societeId120"
                name="societeId120"
                data-cy="societeId120"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.groupeId121')}
                id="table-6-groupeId121"
                name="groupeId121"
                data-cy="groupeId121"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.numBloc122')}
                id="table-6-numBloc122"
                name="numBloc122"
                data-cy="numBloc122"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.typeResv123')}
                id="table-6-typeResv123"
                name="typeResv123"
                data-cy="typeResv123"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.statutResv124')}
                id="table-6-statutResv124"
                name="statutResv124"
                data-cy="statutResv124"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.dateDebutResv125')}
                id="table-6-dateDebutResv125"
                name="dateDebutResv125"
                data-cy="dateDebutResv125"
                type="date"
              />
              <ValidatedField
                label={translate('App.table6.dateFinResv126')}
                id="table-6-dateFinResv126"
                name="dateFinResv126"
                data-cy="dateFinResv126"
                type="date"
              />
              <ValidatedField
                label={translate('App.table6.truncDateDebutResv127')}
                id="table-6-truncDateDebutResv127"
                name="truncDateDebutResv127"
                data-cy="truncDateDebutResv127"
                type="date"
              />
              <ValidatedField
                label={translate('App.table6.truncDateFinResv128')}
                id="table-6-truncDateFinResv128"
                name="truncDateFinResv128"
                data-cy="truncDateFinResv128"
                type="date"
              />
              <ValidatedField
                label={translate('App.table6.dateAnnResv129')}
                id="table-6-dateAnnResv129"
                name="dateAnnResv129"
                data-cy="dateAnnResv129"
                type="date"
              />
              <ValidatedField
                label={translate('App.table6.pseudoRoomYn130')}
                id="table-6-pseudoRoomYn130"
                name="pseudoRoomYn130"
                data-cy="pseudoRoomYn130"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.createurResv131')}
                id="table-6-createurResv131"
                name="createurResv131"
                data-cy="createurResv131"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.nomCreateurResv132')}
                id="table-6-nomCreateurResv132"
                name="nomCreateurResv132"
                data-cy="nomCreateurResv132"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.codeGarantie133')}
                id="table-6-codeGarantie133"
                name="codeGarantie133"
                data-cy="codeGarantie133"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.flgDed134')}
                id="table-6-flgDed134"
                name="flgDed134"
                data-cy="flgDed134"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.codePays135')}
                id="table-6-codePays135"
                name="codePays135"
                data-cy="codePays135"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.libPays136')}
                id="table-6-libPays136"
                name="libPays136"
                data-cy="libPays136"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.codeNationalite137')}
                id="table-6-codeNationalite137"
                name="codeNationalite137"
                data-cy="codeNationalite137"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.libNationalite138')}
                id="table-6-libNationalite138"
                name="libNationalite138"
                data-cy="libNationalite138"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.codeSource139')}
                id="table-6-codeSource139"
                name="codeSource139"
                data-cy="codeSource139"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.libSource140')}
                id="table-6-libSource140"
                name="libSource140"
                data-cy="libSource140"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.codeGrandSource141')}
                id="table-6-codeGrandSource141"
                name="codeGrandSource141"
                data-cy="codeGrandSource141"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.codeOrigine142')}
                id="table-6-codeOrigine142"
                name="codeOrigine142"
                data-cy="codeOrigine142"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.libOrigine143')}
                id="table-6-libOrigine143"
                name="libOrigine143"
                data-cy="libOrigine143"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.codeMarche144')}
                id="table-6-codeMarche144"
                name="codeMarche144"
                data-cy="codeMarche144"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.libMarche145')}
                id="table-6-libMarche145"
                name="libMarche145"
                data-cy="libMarche145"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.codeGrandMarche146')}
                id="table-6-codeGrandMarche146"
                name="codeGrandMarche146"
                data-cy="codeGrandMarche146"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.libGrandMarche147')}
                id="table-6-libGrandMarche147"
                name="libGrandMarche147"
                data-cy="libGrandMarche147"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.codePrix148')}
                id="table-6-codePrix148"
                name="codePrix148"
                data-cy="codePrix148"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.categPrix149')}
                id="table-6-categPrix149"
                name="categPrix149"
                data-cy="categPrix149"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.libPrix150')}
                id="table-6-libPrix150"
                name="libPrix150"
                data-cy="libPrix150"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.numChb151')}
                id="table-6-numChb151"
                name="numChb151"
                data-cy="numChb151"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.descriptionTypeChb152')}
                id="table-6-descriptionTypeChb152"
                name="descriptionTypeChb152"
                data-cy="descriptionTypeChb152"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.codeTypeChb153')}
                id="table-6-codeTypeChb153"
                name="codeTypeChb153"
                data-cy="codeTypeChb153"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.classChb154')}
                id="table-6-classChb154"
                name="classChb154"
                data-cy="classChb154"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.caractChb155')}
                id="table-6-caractChb155"
                name="caractChb155"
                data-cy="caractChb155"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.typeChbDeReservation156')}
                id="table-6-typeChbDeReservation156"
                name="typeChbDeReservation156"
                data-cy="typeChbDeReservation156"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.descriptionTypeChbDeResv157')}
                id="table-6-descriptionTypeChbDeResv157"
                name="descriptionTypeChbDeResv157"
                data-cy="descriptionTypeChbDeResv157"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.codeTypeChbDeResv158')}
                id="table-6-codeTypeChbDeResv158"
                name="codeTypeChbDeResv158"
                data-cy="codeTypeChbDeResv158"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.statutDeReservation159')}
                id="table-6-statutDeReservation159"
                name="statutDeReservation159"
                data-cy="statutDeReservation159"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.circuitDistribution160')}
                id="table-6-circuitDistribution160"
                name="circuitDistribution160"
                data-cy="circuitDistribution160"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.circuitDistribUserRegroup161')}
                id="table-6-circuitDistribUserRegroup161"
                name="circuitDistribUserRegroup161"
                data-cy="circuitDistribUserRegroup161"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.numCrs162')}
                id="table-6-numCrs162"
                name="numCrs162"
                data-cy="numCrs162"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.typeRefCrs163')}
                id="table-6-typeRefCrs163"
                name="typeRefCrs163"
                data-cy="typeRefCrs163"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.crsInsertDate164')}
                id="table-6-crsInsertDate164"
                name="crsInsertDate164"
                data-cy="crsInsertDate164"
                type="date"
              />
              <ValidatedField
                label={translate('App.table6.dateCreaResv165')}
                id="table-6-dateCreaResv165"
                name="dateCreaResv165"
                data-cy="dateCreaResv165"
                type="date"
              />
              <ValidatedField
                label={translate('App.table6.datePremier166')}
                id="table-6-datePremier166"
                name="datePremier166"
                data-cy="datePremier166"
                type="date"
              />
              <ValidatedField
                label={translate('App.table6.statutPremier167')}
                id="table-6-statutPremier167"
                name="statutPremier167"
                data-cy="statutPremier167"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.dateDernier168')}
                id="table-6-dateDernier168"
                name="dateDernier168"
                data-cy="dateDernier168"
                type="date"
              />
              <ValidatedField
                label={translate('App.table6.statutDernier169')}
                id="table-6-statutDernier169"
                name="statutDernier169"
                data-cy="statutDernier169"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.dateDernierPseudo170')}
                id="table-6-dateDernierPseudo170"
                name="dateDernierPseudo170"
                data-cy="dateDernierPseudo170"
                type="date"
              />
              <ValidatedField
                label={translate('App.table6.statutDernierPseudo171')}
                id="table-6-statutDernierPseudo171"
                name="statutDernierPseudo171"
                data-cy="statutDernierPseudo171"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.diffDtCreaAnn172')}
                id="table-6-diffDtCreaAnn172"
                name="diffDtCreaAnn172"
                data-cy="diffDtCreaAnn172"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.diffDtArrAnn173')}
                id="table-6-diffDtArrAnn173"
                name="diffDtArrAnn173"
                data-cy="diffDtArrAnn173"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.leadtime174')}
                id="table-6-leadtime174"
                name="leadtime174"
                data-cy="leadtime174"
                type="text"
              />
              <ValidatedField label={translate('App.table6.los175')} id="table-6-los175" name="los175" data-cy="los175" type="text" />
              <ValidatedField
                label={translate('App.table6.occupantsGroupe176')}
                id="table-6-occupantsGroupe176"
                name="occupantsGroupe176"
                data-cy="occupantsGroupe176"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.nbNuitee177')}
                id="table-6-nbNuitee177"
                name="nbNuitee177"
                data-cy="nbNuitee177"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.nbNuiteeNnDed178')}
                id="table-6-nbNuiteeNnDed178"
                name="nbNuiteeNnDed178"
                data-cy="nbNuiteeNnDed178"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.nbResvAnn179')}
                id="table-6-nbResvAnn179"
                name="nbResvAnn179"
                data-cy="nbResvAnn179"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.nbAdu180')}
                id="table-6-nbAdu180"
                name="nbAdu180"
                data-cy="nbAdu180"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.nbEnf181')}
                id="table-6-nbEnf181"
                name="nbEnf181"
                data-cy="nbEnf181"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.nbPersDayU182')}
                id="table-6-nbPersDayU182"
                name="nbPersDayU182"
                data-cy="nbPersDayU182"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.nbPersArr183')}
                id="table-6-nbPersArr183"
                name="nbPersArr183"
                data-cy="nbPersArr183"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.nbPersDep184')}
                id="table-6-nbPersDep184"
                name="nbPersDep184"
                data-cy="nbPersDep184"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.nbPersAnn185')}
                id="table-6-nbPersAnn185"
                name="nbPersAnn185"
                data-cy="nbPersAnn185"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.nbPersNoshow186')}
                id="table-6-nbPersNoshow186"
                name="nbPersNoshow186"
                data-cy="nbPersNoshow186"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.nbChbDayU187')}
                id="table-6-nbChbDayU187"
                name="nbChbDayU187"
                data-cy="nbChbDayU187"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.nbChbArr188')}
                id="table-6-nbChbArr188"
                name="nbChbArr188"
                data-cy="nbChbArr188"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.nbChbDep189')}
                id="table-6-nbChbDep189"
                name="nbChbDep189"
                data-cy="nbChbDep189"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.nbChbAnn190')}
                id="table-6-nbChbAnn190"
                name="nbChbAnn190"
                data-cy="nbChbAnn190"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.nbChbNoshow191')}
                id="table-6-nbChbNoshow191"
                name="nbChbNoshow191"
                data-cy="nbChbNoshow191"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.revenuNetChambre192')}
                id="table-6-revenuNetChambre192"
                name="revenuNetChambre192"
                data-cy="revenuNetChambre192"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.revenuTaxeChambre193')}
                id="table-6-revenuTaxeChambre193"
                name="revenuTaxeChambre193"
                data-cy="revenuTaxeChambre193"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.revenuNetChambreGlobal194')}
                id="table-6-revenuNetChambreGlobal194"
                name="revenuNetChambreGlobal194"
                data-cy="revenuNetChambreGlobal194"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.revenuTaxeChambreGlobal195')}
                id="table-6-revenuTaxeChambreGlobal195"
                name="revenuTaxeChambreGlobal195"
                data-cy="revenuTaxeChambreGlobal195"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.revenuNetBq196')}
                id="table-6-revenuNetBq196"
                name="revenuNetBq196"
                data-cy="revenuNetBq196"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.revenuTaxeBq197')}
                id="table-6-revenuTaxeBq197"
                name="revenuTaxeBq197"
                data-cy="revenuTaxeBq197"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.revenuNetBqGlobal198')}
                id="table-6-revenuNetBqGlobal198"
                name="revenuNetBqGlobal198"
                data-cy="revenuNetBqGlobal198"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.revenuTaxeBqGlobal199')}
                id="table-6-revenuTaxeBqGlobal199"
                name="revenuTaxeBqGlobal199"
                data-cy="revenuTaxeBqGlobal199"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.revenuNetExtra200')}
                id="table-6-revenuNetExtra200"
                name="revenuNetExtra200"
                data-cy="revenuNetExtra200"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.revenuTaxeExtra201')}
                id="table-6-revenuTaxeExtra201"
                name="revenuTaxeExtra201"
                data-cy="revenuTaxeExtra201"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.revenuNetExtraGlobal202')}
                id="table-6-revenuNetExtraGlobal202"
                name="revenuNetExtraGlobal202"
                data-cy="revenuNetExtraGlobal202"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.revenuTaxeExtraGlobal203')}
                id="table-6-revenuTaxeExtraGlobal203"
                name="revenuTaxeExtraGlobal203"
                data-cy="revenuTaxeExtraGlobal203"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.revenuNetTotal204')}
                id="table-6-revenuNetTotal204"
                name="revenuNetTotal204"
                data-cy="revenuNetTotal204"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.revenuTaxeTotal205')}
                id="table-6-revenuTaxeTotal205"
                name="revenuTaxeTotal205"
                data-cy="revenuTaxeTotal205"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.revenuNetTotalGlobal206')}
                id="table-6-revenuNetTotalGlobal206"
                name="revenuNetTotalGlobal206"
                data-cy="revenuNetTotalGlobal206"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.revenuTaxeTotalGlobal207')}
                id="table-6-revenuTaxeTotalGlobal207"
                name="revenuTaxeTotalGlobal207"
                data-cy="revenuTaxeTotalGlobal207"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.prodRevenuChambre208')}
                id="table-6-prodRevenuChambre208"
                name="prodRevenuChambre208"
                data-cy="prodRevenuChambre208"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.prodRevenuBq209')}
                id="table-6-prodRevenuBq209"
                name="prodRevenuBq209"
                data-cy="prodRevenuBq209"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.prodRevenuExtra210')}
                id="table-6-prodRevenuExtra210"
                name="prodRevenuExtra210"
                data-cy="prodRevenuExtra210"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.prodRevenuTotal211')}
                id="table-6-prodRevenuTotal211"
                name="prodRevenuTotal211"
                data-cy="prodRevenuTotal211"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.prodChambreNbNuitees212')}
                id="table-6-prodChambreNbNuitees212"
                name="prodChambreNbNuitees212"
                data-cy="prodChambreNbNuitees212"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.techCreateDate213')}
                id="table-6-techCreateDate213"
                name="techCreateDate213"
                data-cy="techCreateDate213"
                type="date"
              />
              <ValidatedField
                label={translate('App.table6.techUpdateDate214')}
                id="table-6-techUpdateDate214"
                name="techUpdateDate214"
                data-cy="techUpdateDate214"
                type="date"
              />
              <ValidatedField
                label={translate('App.table6.numLigne215')}
                id="table-6-numLigne215"
                name="numLigne215"
                data-cy="numLigne215"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.resort216')}
                id="table-6-resort216"
                name="resort216"
                data-cy="resort216"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.resvNameId217')}
                id="table-6-resvNameId217"
                name="resvNameId217"
                data-cy="resvNameId217"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.clientOId218')}
                id="table-6-clientOId218"
                name="clientOId218"
                data-cy="clientOId218"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.typeChb219')}
                id="table-6-typeChb219"
                name="typeChb219"
                data-cy="typeChb219"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.confirmationNo220')}
                id="table-6-confirmationNo220"
                name="confirmationNo220"
                data-cy="confirmationNo220"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.clientMdmId221')}
                id="table-6-clientMdmId221"
                name="clientMdmId221"
                data-cy="clientMdmId221"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.nameId222')}
                id="table-6-nameId222"
                name="nameId222"
                data-cy="nameId222"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.parentResvNameId223')}
                id="table-6-parentResvNameId223"
                name="parentResvNameId223"
                data-cy="parentResvNameId223"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.contactId224')}
                id="table-6-contactId224"
                name="contactId224"
                data-cy="contactId224"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.agenceId225')}
                id="table-6-agenceId225"
                name="agenceId225"
                data-cy="agenceId225"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.agenceNom226')}
                id="table-6-agenceNom226"
                name="agenceNom226"
                data-cy="agenceNom226"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.societeId227')}
                id="table-6-societeId227"
                name="societeId227"
                data-cy="societeId227"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.groupeId228')}
                id="table-6-groupeId228"
                name="groupeId228"
                data-cy="groupeId228"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.numBloc229')}
                id="table-6-numBloc229"
                name="numBloc229"
                data-cy="numBloc229"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.typeResv230')}
                id="table-6-typeResv230"
                name="typeResv230"
                data-cy="typeResv230"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.statutResv231')}
                id="table-6-statutResv231"
                name="statutResv231"
                data-cy="statutResv231"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.dateDebutResv232')}
                id="table-6-dateDebutResv232"
                name="dateDebutResv232"
                data-cy="dateDebutResv232"
                type="date"
              />
              <ValidatedField
                label={translate('App.table6.dateFinResv233')}
                id="table-6-dateFinResv233"
                name="dateFinResv233"
                data-cy="dateFinResv233"
                type="date"
              />
              <ValidatedField
                label={translate('App.table6.truncDateDebutResv234')}
                id="table-6-truncDateDebutResv234"
                name="truncDateDebutResv234"
                data-cy="truncDateDebutResv234"
                type="date"
              />
              <ValidatedField
                label={translate('App.table6.truncDateFinResv235')}
                id="table-6-truncDateFinResv235"
                name="truncDateFinResv235"
                data-cy="truncDateFinResv235"
                type="date"
              />
              <ValidatedField
                label={translate('App.table6.dateAnnResv236')}
                id="table-6-dateAnnResv236"
                name="dateAnnResv236"
                data-cy="dateAnnResv236"
                type="date"
              />
              <ValidatedField
                label={translate('App.table6.pseudoRoomYn237')}
                id="table-6-pseudoRoomYn237"
                name="pseudoRoomYn237"
                data-cy="pseudoRoomYn237"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.createurResv238')}
                id="table-6-createurResv238"
                name="createurResv238"
                data-cy="createurResv238"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.nomCreateurResv239')}
                id="table-6-nomCreateurResv239"
                name="nomCreateurResv239"
                data-cy="nomCreateurResv239"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.codeGarantie240')}
                id="table-6-codeGarantie240"
                name="codeGarantie240"
                data-cy="codeGarantie240"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.flgDed241')}
                id="table-6-flgDed241"
                name="flgDed241"
                data-cy="flgDed241"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.codePays242')}
                id="table-6-codePays242"
                name="codePays242"
                data-cy="codePays242"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.libPays243')}
                id="table-6-libPays243"
                name="libPays243"
                data-cy="libPays243"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.codeNationalite244')}
                id="table-6-codeNationalite244"
                name="codeNationalite244"
                data-cy="codeNationalite244"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.libNationalite245')}
                id="table-6-libNationalite245"
                name="libNationalite245"
                data-cy="libNationalite245"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.codeSource246')}
                id="table-6-codeSource246"
                name="codeSource246"
                data-cy="codeSource246"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.libSource247')}
                id="table-6-libSource247"
                name="libSource247"
                data-cy="libSource247"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.codeGrandSource248')}
                id="table-6-codeGrandSource248"
                name="codeGrandSource248"
                data-cy="codeGrandSource248"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.codeOrigine249')}
                id="table-6-codeOrigine249"
                name="codeOrigine249"
                data-cy="codeOrigine249"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.libOrigine250')}
                id="table-6-libOrigine250"
                name="libOrigine250"
                data-cy="libOrigine250"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.codeMarche251')}
                id="table-6-codeMarche251"
                name="codeMarche251"
                data-cy="codeMarche251"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.libMarche252')}
                id="table-6-libMarche252"
                name="libMarche252"
                data-cy="libMarche252"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.codeGrandMarche253')}
                id="table-6-codeGrandMarche253"
                name="codeGrandMarche253"
                data-cy="codeGrandMarche253"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.libGrandMarche254')}
                id="table-6-libGrandMarche254"
                name="libGrandMarche254"
                data-cy="libGrandMarche254"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.codePrix255')}
                id="table-6-codePrix255"
                name="codePrix255"
                data-cy="codePrix255"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.categPrix256')}
                id="table-6-categPrix256"
                name="categPrix256"
                data-cy="categPrix256"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.libPrix257')}
                id="table-6-libPrix257"
                name="libPrix257"
                data-cy="libPrix257"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.numChb258')}
                id="table-6-numChb258"
                name="numChb258"
                data-cy="numChb258"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.descriptionTypeChb259')}
                id="table-6-descriptionTypeChb259"
                name="descriptionTypeChb259"
                data-cy="descriptionTypeChb259"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.codeTypeChb260')}
                id="table-6-codeTypeChb260"
                name="codeTypeChb260"
                data-cy="codeTypeChb260"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.classChb261')}
                id="table-6-classChb261"
                name="classChb261"
                data-cy="classChb261"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.caractChb262')}
                id="table-6-caractChb262"
                name="caractChb262"
                data-cy="caractChb262"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.typeChbDeReservation263')}
                id="table-6-typeChbDeReservation263"
                name="typeChbDeReservation263"
                data-cy="typeChbDeReservation263"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.descriptionTypeChbDeResv264')}
                id="table-6-descriptionTypeChbDeResv264"
                name="descriptionTypeChbDeResv264"
                data-cy="descriptionTypeChbDeResv264"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.codeTypeChbDeResv265')}
                id="table-6-codeTypeChbDeResv265"
                name="codeTypeChbDeResv265"
                data-cy="codeTypeChbDeResv265"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.statutDeReservation266')}
                id="table-6-statutDeReservation266"
                name="statutDeReservation266"
                data-cy="statutDeReservation266"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.circuitDistribution267')}
                id="table-6-circuitDistribution267"
                name="circuitDistribution267"
                data-cy="circuitDistribution267"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.circuitDistribUserRegroup268')}
                id="table-6-circuitDistribUserRegroup268"
                name="circuitDistribUserRegroup268"
                data-cy="circuitDistribUserRegroup268"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.numCrs269')}
                id="table-6-numCrs269"
                name="numCrs269"
                data-cy="numCrs269"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.typeRefCrs270')}
                id="table-6-typeRefCrs270"
                name="typeRefCrs270"
                data-cy="typeRefCrs270"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.crsInsertDate271')}
                id="table-6-crsInsertDate271"
                name="crsInsertDate271"
                data-cy="crsInsertDate271"
                type="date"
              />
              <ValidatedField
                label={translate('App.table6.dateCreaResv272')}
                id="table-6-dateCreaResv272"
                name="dateCreaResv272"
                data-cy="dateCreaResv272"
                type="date"
              />
              <ValidatedField
                label={translate('App.table6.datePremier273')}
                id="table-6-datePremier273"
                name="datePremier273"
                data-cy="datePremier273"
                type="date"
              />
              <ValidatedField
                label={translate('App.table6.statutPremier274')}
                id="table-6-statutPremier274"
                name="statutPremier274"
                data-cy="statutPremier274"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.dateDernier275')}
                id="table-6-dateDernier275"
                name="dateDernier275"
                data-cy="dateDernier275"
                type="date"
              />
              <ValidatedField
                label={translate('App.table6.statutDernier276')}
                id="table-6-statutDernier276"
                name="statutDernier276"
                data-cy="statutDernier276"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.dateDernierPseudo277')}
                id="table-6-dateDernierPseudo277"
                name="dateDernierPseudo277"
                data-cy="dateDernierPseudo277"
                type="date"
              />
              <ValidatedField
                label={translate('App.table6.statutDernierPseudo278')}
                id="table-6-statutDernierPseudo278"
                name="statutDernierPseudo278"
                data-cy="statutDernierPseudo278"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.diffDtCreaAnn279')}
                id="table-6-diffDtCreaAnn279"
                name="diffDtCreaAnn279"
                data-cy="diffDtCreaAnn279"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.diffDtArrAnn280')}
                id="table-6-diffDtArrAnn280"
                name="diffDtArrAnn280"
                data-cy="diffDtArrAnn280"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.leadtime281')}
                id="table-6-leadtime281"
                name="leadtime281"
                data-cy="leadtime281"
                type="text"
              />
              <ValidatedField label={translate('App.table6.los282')} id="table-6-los282" name="los282" data-cy="los282" type="text" />
              <ValidatedField
                label={translate('App.table6.occupantsGroupe283')}
                id="table-6-occupantsGroupe283"
                name="occupantsGroupe283"
                data-cy="occupantsGroupe283"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.nbNuitee284')}
                id="table-6-nbNuitee284"
                name="nbNuitee284"
                data-cy="nbNuitee284"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.nbNuiteeNnDed285')}
                id="table-6-nbNuiteeNnDed285"
                name="nbNuiteeNnDed285"
                data-cy="nbNuiteeNnDed285"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.nbResvAnn286')}
                id="table-6-nbResvAnn286"
                name="nbResvAnn286"
                data-cy="nbResvAnn286"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.nbAdu287')}
                id="table-6-nbAdu287"
                name="nbAdu287"
                data-cy="nbAdu287"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.nbEnf288')}
                id="table-6-nbEnf288"
                name="nbEnf288"
                data-cy="nbEnf288"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.nbPersDayU289')}
                id="table-6-nbPersDayU289"
                name="nbPersDayU289"
                data-cy="nbPersDayU289"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.nbPersArr290')}
                id="table-6-nbPersArr290"
                name="nbPersArr290"
                data-cy="nbPersArr290"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.nbPersDep291')}
                id="table-6-nbPersDep291"
                name="nbPersDep291"
                data-cy="nbPersDep291"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.nbPersAnn292')}
                id="table-6-nbPersAnn292"
                name="nbPersAnn292"
                data-cy="nbPersAnn292"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.nbPersNoshow293')}
                id="table-6-nbPersNoshow293"
                name="nbPersNoshow293"
                data-cy="nbPersNoshow293"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.nbChbDayU294')}
                id="table-6-nbChbDayU294"
                name="nbChbDayU294"
                data-cy="nbChbDayU294"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.nbChbArr295')}
                id="table-6-nbChbArr295"
                name="nbChbArr295"
                data-cy="nbChbArr295"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.nbChbDep296')}
                id="table-6-nbChbDep296"
                name="nbChbDep296"
                data-cy="nbChbDep296"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.nbChbAnn297')}
                id="table-6-nbChbAnn297"
                name="nbChbAnn297"
                data-cy="nbChbAnn297"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.nbChbNoshow298')}
                id="table-6-nbChbNoshow298"
                name="nbChbNoshow298"
                data-cy="nbChbNoshow298"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.revenuNetChambre299')}
                id="table-6-revenuNetChambre299"
                name="revenuNetChambre299"
                data-cy="revenuNetChambre299"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.revenuTaxeChambre300')}
                id="table-6-revenuTaxeChambre300"
                name="revenuTaxeChambre300"
                data-cy="revenuTaxeChambre300"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.revenuNetChambreGlobal301')}
                id="table-6-revenuNetChambreGlobal301"
                name="revenuNetChambreGlobal301"
                data-cy="revenuNetChambreGlobal301"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.revenuTaxeChambreGlobal302')}
                id="table-6-revenuTaxeChambreGlobal302"
                name="revenuTaxeChambreGlobal302"
                data-cy="revenuTaxeChambreGlobal302"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.revenuNetBq303')}
                id="table-6-revenuNetBq303"
                name="revenuNetBq303"
                data-cy="revenuNetBq303"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.revenuTaxeBq304')}
                id="table-6-revenuTaxeBq304"
                name="revenuTaxeBq304"
                data-cy="revenuTaxeBq304"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.revenuNetBqGlobal305')}
                id="table-6-revenuNetBqGlobal305"
                name="revenuNetBqGlobal305"
                data-cy="revenuNetBqGlobal305"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.revenuTaxeBqGlobal306')}
                id="table-6-revenuTaxeBqGlobal306"
                name="revenuTaxeBqGlobal306"
                data-cy="revenuTaxeBqGlobal306"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.revenuNetExtra307')}
                id="table-6-revenuNetExtra307"
                name="revenuNetExtra307"
                data-cy="revenuNetExtra307"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.revenuTaxeExtra308')}
                id="table-6-revenuTaxeExtra308"
                name="revenuTaxeExtra308"
                data-cy="revenuTaxeExtra308"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.revenuNetExtraGlobal309')}
                id="table-6-revenuNetExtraGlobal309"
                name="revenuNetExtraGlobal309"
                data-cy="revenuNetExtraGlobal309"
                type="text"
              />
              <ValidatedField
                label={translate('App.table6.revenuTaxeExtraGlobal310')}
                id="table-6-revenuTaxeExtraGlobal310"
                name="revenuTaxeExtraGlobal310"
                data-cy="revenuTaxeExtraGlobal310"
                type="text"
              />
              <Button tag={Link} id="cancel-save" data-cy="entityCreateCancelButton" to="/table-6" replace color="info">
