  ...
  return (
    <div>
      <h2 id="table-4-heading" data-cy="Table4Heading">
        <Translate contentKey="App.table4.home.title">Table 4 S</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} /> <Translate contentKey="App.table4.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/table-4/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="App.table4.home.createLabel">Create new Table 4</Translate>
          </Link>
        </div>
      </h2>
        ...
        {table4List && table4List.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="App.table4.id">ID</Translate> <FontAwesomeIcon icon={getSortIconByFieldName('id')} />
                </th>
                ...
                <th className="hand" onClick={sort('los68')}>
                  <Translate contentKey="App.table4.los68">Los 68</Translate> <FontAwesomeIcon icon={getSortIconByFieldName('los68')} />
                </th>
                ...
                <th className="hand" onClick={sort('los175')}>
                  <Translate contentKey="App.table4.los175">Los 175</Translate> <FontAwesomeIcon icon={getSortIconByFieldName('los175')} />
                </th>
                ...
                <th className="hand" onClick={sort('los282')}>
                  <Translate contentKey="App.table4.los282">Los 282</Translate> <FontAwesomeIcon icon={getSortIconByFieldName('los282')} />
                </th>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="App.table4.home.notFound">No Table 4 S found</Translate>
            </div>
          )
        )}
      </div>
